  ...
  data() {
    return {
      columns: [{field:'ProcessList_Id',title:'工序采集数据主键ID',type:'int',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'DataPointType',title:'类型',type:'string',readonly:true,bind:{ key:'dataPointType',data:[]},sort:true,width:180,edit:{type:'select'},require:true,align:'left'},
                       {field:'DataPointName',title:'名称',type:'string',readonly:true,sort:true,width:180,edit:{type:'text'},require:true,align:'left'},
