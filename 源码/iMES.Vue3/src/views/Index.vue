  ...
  <div id="mes-container" :class="['mes-theme-' + theme]">
    <div class="mes-aside" :style="{ width: menuWidth + 'px' }">
      <div class="header" :style="{ width: menuWidth - 1 + 'px' }">
        ...
        <div
          style="z-index: 999; font-size: 40px; font-weight: 700; color: #fff"
        >
          MES
        </div>
    ...
    <div class="mes-container" :style="{ left: menuWidth - 1 + 'px' }">
      <div class="mes-header">
        <div class="project-name">您的新一代工厂管家</div>
...
export default defineComponent({
  ...
  mounted() {
    ...
    http.get('api/menu/getTreeMenu', {}, true).then((data) => {
      let menuRoot = data.filter(
        (item) => item.parentId != 0 && item.url != '/home'
      )
      this.optionsRoot = menuRoot.map((item) => ({
        value: item.url,
        label: item.name,
      }))
